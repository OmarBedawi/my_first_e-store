...
class Order(models.Model):
    ...
    def update_total(self):
        ...
        self.grand_total = self.lineitemsreader.aggregate(
            Sum('lineitem_total'))['lineitem_total__sum'] or 0

        self.grand_total = self.grand_total + self.order_total
        self.save()
...
class OrderLineItem(models.Model):
    ...
    ebook = models.ForeignKey(
        Ebook, null=False, blank=False, on_delete=models.CASCADE)
    ...
    def save(self, *args, **kwargs):
        ...
        """
        self.lineitem_total = self.ebook.price * self.quantity
        super().save(*args, **kwargs)
