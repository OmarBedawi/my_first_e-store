from django.shortcuts import render, redirect, reverse, get_object_or_404, HttpResponse  # noqa: disable=line-too-long
                ...
                try:
                    ...
                    try:
                        ...
                        messages.error(request, (
                            "One of the products in your bag wasn't found in our database. Please contact us for assistance!")  # noqa: disable=line-too-long
                        )
                        order.delete()
